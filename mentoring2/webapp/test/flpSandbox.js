		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[D12] 멘토링 실습2",
									"targetURL": "#syncd12mentoring2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncd12mentoring2-display": {
								"semanticObject": "syncd12mentoring2",
								"action": "display",
								"description": "멘토링 실습2",
								"title": "[D12] 멘토링 실습2",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.d12.mentoring2",
									"url": sap.ui.require.toUrl("sync/d12/mentoring2")
								}
							}
						}
					}
