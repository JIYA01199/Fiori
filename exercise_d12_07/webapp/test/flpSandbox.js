		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#syncd12exercised1207-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncd12exercised1207-display": {
								"semanticObject": "syncd12exercised1207",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.d12.exercised1207",
									"url": sap.ui.require.toUrl("sync/d12/exercised1207")
								}
							}
						}
					}
